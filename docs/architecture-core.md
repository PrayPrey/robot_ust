# LLM_ROBOT_2 - Core Architecture (Epic 1-2)

**Project:** LLM_ROBOT_2 - Search & Rescue Robot
**Author:** BMad
**Date:** 2025-10-29
**Version:** 2.0 (Epic 1-2 Foundation)

---

**📚 Navigation:**
- [← Overview](./architecture-overview.md) | **Current: Core (Epic 1-2)** | [Epic 3 →](./architecture-epic3.md)
...
**Core Architecture Complete (Epic 1-2)**

이 문서는 Epic 1-2 Foundation 아키텍처를 다룹니다. Epic 3 Real-time Control & Web Interface는 [architecture-epic3.md](./architecture-epic3.md)를 참조하세요.
